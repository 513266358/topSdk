...
class AlitripAgentFlightSellModifyBackfillModifyItemDTO {
    ...
    public function getTicketNos() : array{
        return $this->ticket_nos;
    }

    public function setTicketNos(array $ticketNos){
        $this->ticket_nos = $ticketNos;
    }
